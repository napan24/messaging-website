    ...
    <>
            {profilePageToggle ?
                <div className='left-container'>
                    <div id='logOutButtonPopUp' style={{ display: "none", position: "absolute", backgroundColor: "white", color: "grey", zIndex: "2", right: "1vw", top: "9vh", display: "none" }}>
                    ...
                    <div className="input-group" style={{ height: "7vh", width: "100vw" }}>
                    ...
                    <div style={{ position: "absolute", top: "19vh", width: "100vw", zIndex: "2" }}>
                    ...
                    <div style={{ width: "100vw", height: "81vh", overflowY: "scroll", backgroundColor: "white" }}>
                        {filterUnread?
                        props.userList.filter(user=>user.unread>0).map((user) => (
                            <>
                                <div key={user.reciever} className='userList' onMouseOver={handleMouseInUserList} onMouseOut={handleMouseOutUserList} onClick={() => { props.func(user) }} style={{ width: "99.5vw", height: "10vh", color: "#111b21", backgroundColor: "white", borderBottom: "1px solid #e9edef", position: "relative", cursor: "pointer" }}>
                                    <div>
                                    ...
                                    <div className="sidebar_name" style={{ position: "absolute", left: "5.5vw", marginTop: "1vh" }}>
                                        ...
                                        <span className="userListMsg" style={{ width: "95vw", height: "4vh", position: "absolute", color: "#667781", overflowY: "hidden", fontWeight: "300" }}>{props.titleCase(user.msg)}</span>
                                    </div>
                ...
                <div className='my-node' style={{ width: "100vw", height: "100vh" }}>
                    <div />
                    <nav className="navbar" style={{ backgroundColor: "#008069", width: "100vw", position: "relative", height: "12vh" }}>
                    ...
                    <div style={{ height: "88vh", width: "100vw", overflowY: "scroll", backgroundColor: "rgb(240, 242, 245)" }}>
                        ...
                        <div style={{ width: "99.5vw", height: "15vh", backgroundColor: "white", position: "relative", top: "10vh" }}>
                            ...
                            <div className='profilePageName' style={{ position: "absolute", left: "5%", top: "50%" }}>
                                <input value={props.titleCase(profilename)} onChange={changeProfileName} type="text" style={{ width: "92vw", outlineColor: "transparent", borderColor: "transparent" }} placeholder="Enter Username" aria-label="Username" aria-describedby="basic-addon1" />
                            </div>
