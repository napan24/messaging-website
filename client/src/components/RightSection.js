...
const RightSection = (props) => {
    ...
    <>
        <div className='right-container' style={{ position: "relative" }}>
                    <Picker preload={true} pickerStyle={{ position: 'absolute', bottom: "10vh", width: emojiPickerShow ? "25vw" : "0vw", height: emojiPickerShow ? "50vh" : "0", marginLeft: "0.5vw" }} onEmojiClick={onEmojiClick} />
                            ...
                            <>
                                <div style={{ display: "flex", flexDirection: "row" }}>
                                    <div>
                                        ...
                                        <nav className="navbar" style={{ backgroundColor: "#f0f2f5", width: "35.9vw", position: "relative", height: "12vh" }}>
                                        ...
                                        <div style={{ width: "35.9vw", height: "78vh", backgroundImage: "url(" + background + ")", backgroundSize: "contain", overflowY: "scroll", display: "flex", flexDirection: "column-reverse" }}>
                                        ...
                                        <nav className="navbar" style={{ backgroundColor: "#f0f2f5", width: "35.9vw", position: "relative", height: "10vh", display: "inline-block" }}>
                            ...
                            <>
                                <div initial={{ x: "64.9vw" }} animate={{ x: "0" }} transition={{ ease: "easeOut", duration: 1 }}>
                                    <div>
                                        ...
                                        <nav className="navbar" style={{ backgroundColor: "#f0f2f5", width: "64.9vw", position: "relative", height: "12vh" }}>
                                        ...
                                        <div style={{ width: "64.9vw", height: "78vh", backgroundImage: "url(" + background + ")", backgroundSize: "contain", overflowY: "scroll", display: "flex", flexDirection: "column-reverse" }}>
                                        ...
                                        <nav className="navbar" style={{ backgroundColor: "#f0f2f5", width: "64.9vw", position: "relative", height: "10vh", display: "inline-block" }}>
